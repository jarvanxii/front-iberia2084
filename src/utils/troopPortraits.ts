...
import funcionarioRasoPortrait from '@/assets/troops/funcionario-raso.png'
import gilCapatazGruaPortrait from '@/assets/troops/gil-capataz-grua-dorada.png'
import gilConcejalaFestejosPortrait from '@/assets/troops/gil-concejala-festejos-premium.png'
import gilDjInauguracionesPortrait from '@/assets/troops/gil-dj-inauguraciones.png'
import gilPromotorRotondasPortrait from '@/assets/troops/gil-promotor-rotondas.png'
import gilSubasteroPlayaPortrait from '@/assets/troops/gil-subastero-playa-infinita.png'
import inspectorHaciendaPortrait from '@/assets/troops/inspector-hacienda.png'
import juntsConsellerFronteraPortrait from '@/assets/troops/junts-conseller-frontera-simbolica.png'
import juntsConselleraRotuladorPortrait from '@/assets/troops/junts-consellera-frontera-rotulador.png'
import juntsEmbajadorVentanillaPortrait from '@/assets/troops/junts-embajador-ventanilla-propia.png'
import juntsNegociadoraPeajePortrait from '@/assets/troops/junts-negociadora-peaje.png'
import juntsNegociadorPeajePortatilPortrait from '@/assets/troops/junts-negociador-peaje-portatil.png'
import lanchaPublicitariaPortrait from '@/assets/troops/lancha-publicitaria.png'
import periodistaPortrait from '@/assets/troops/periodista.png'
import peugeotCampanaPortrait from '@/assets/troops/peugeot-campana.png'
...
import voxCapitanaCornetaPortrait from '@/assets/troops/vox-capitana-corneta-reglamentaria.png'
import voxHeraldoAtrilPortrait from '@/assets/troops/vox-heraldo-atril-verde.png'
import voxNotarioPatriaPortrait from '@/assets/troops/vox-notario-patria-sello-xxl.png'
import voxTamborileraBalconPortrait from '@/assets/troops/vox-tamborilera-balcon.png'
import voxTamborMayorPortrait from '@/assets/troops/vox-tambor-mayor-balcones.png'
import yateDesgrabablePortrait from '@/assets/troops/yate-desgrabable.png'
...
const troopPortraits: Record<string, string> = {
  ...
  'gil-dj-inauguraciones': gilDjInauguracionesPortrait,
  'gil-promotor-rotondas': gilPromotorRotondasPortrait,
  'gil-subastero-playa-infinita': gilSubasteroPlayaPortrait,
  'inspector-hacienda': inspectorHaciendaPortrait,
  'junts-conseller-frontera-simbolica': juntsConsellerFronteraPortrait,
  'junts-consellera-frontera-rotulador': juntsConselleraRotuladorPortrait,
  'junts-embajador-ventanilla-propia': juntsEmbajadorVentanillaPortrait,
  'junts-negociadora-peaje': juntsNegociadoraPeajePortrait,
  'junts-negociador-peaje-portatil': juntsNegociadorPeajePortatilPortrait,
  'lancha-publicitaria': lanchaPublicitariaPortrait,
  periodista: periodistaPortrait,
  'peugeot-campana': peugeotCampanaPortrait,
  ...
  'vox-capitana-corneta-reglamentaria': voxCapitanaCornetaPortrait,
  'vox-heraldo-atril-verde': voxHeraldoAtrilPortrait,
  'vox-notario-patria-sello-xxl': voxNotarioPatriaPortrait,
  'vox-tamborilera-balcon': voxTamborileraBalconPortrait,
  'vox-tambor-mayor-balcones': voxTamborMayorPortrait,
  'yate-desgrabable': yateDesgrabablePortrait,
}

export function troopPortrait(imageKey: string) {
  return troopPortraits[imageKey] ?? funcionarioRasoPortrait
}
